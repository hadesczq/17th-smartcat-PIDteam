...
//必须4字节对齐
IFX_ALIGN(4) uint8 mt9v03x_image[2 * MT9V03X_H][2 * MT9V03X_W];
...
int16 MT9V03X_CFG[CONFIG_FINISH][2]=
{
    ...
    {SET_COL,           2 * MT9V03X_W}, //图像列数量        范围1-752     K60采集不允许超过188
    {SET_ROW,           2 * MT9V03X_H}, //图像行数量        范围1-480
...
//    systick_delay_ms(STM0, 1000);//延时方式
    ...
    link_list_num = eru_dma_init(MT9V03X_DMA_CH, GET_PORT_IN_ADDR(MT9V03X_DATA_PIN), camera_buffer_addr, MT9V03X_PCLK_PIN, FALLING, 2 * MT9V03X_W * 2 * MT9V03X_H);//如果超频到300M 倒数第二个参数请设置为FALLING
...
void mt9v03x_vsync(void)
{
	...
	if(mt9v03x_dma_init_flag)
	{
		...
		link_list_num = eru_dma_init(MT9V03X_DMA_CH, GET_PORT_IN_ADDR(MT9V03X_DATA_PIN), camera_buffer_addr, MT9V03X_PCLK_PIN, FALLING, 2 * MT9V03X_W * 2 * MT9V03X_H);
